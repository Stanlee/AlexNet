...
class Inception(object):
  ...
  def create(self):
    ...
    lrn1 = tf.nn.relu(conv1, name='relu1')
    ...
    lrn2 = tf.nn.relu(conv2, name='relu2')
    ...
    with tf.variable_scope("IR_branch_0"):
        br0 = tf.layers.conv2d(pool2, 256, [1, 1], padding='SAME',
                               activation=tf.nn.relu,
                               use_bias=True, name='conv_1x1_1',
                               kernel_initializer=tf.truncated_normal_initializer(stddev=0.01))
        # BN?
    with tf.variable_scope("IR_branch_1"):
        br1 = tf.layers.conv2d(pool2, 256, [1, 1], padding='SAME',
                               activation=tf.nn.relu,
                               use_bias=True, name='conv_1x1_2',
                               kernel_initializer=tf.truncated_normal_initializer(stddev=0.01))
    ...
    with tf.variable_scope("IR_branch_2"):
        br2 = tf.layers.conv2d(pool2, 256, [1, 1], padding='SAME',
                               activation=tf.nn.relu,
                               use_bias=True, name='conv_1x1_3',
                               kernel_initializer=tf.truncated_normal_initializer(stddev=0.01))
        # BN?
        br2 = tf.layers.conv2d(br2, 256, [3, 3], padding='SAME',
                               activation=tf.nn.relu,
                               use_bias=True, name='conv_3x3_3',
                               kernel_initializer=tf.truncated_normal_initializer(stddev=0.01))
        # BN?
        br2 = tf.layers.conv2d(br2, 256, [3, 3], padding='SAME',
                               activation=tf.nn.relu,
                               use_bias=True, name='conv_3x3_2_3',
                               kernel_initializer=tf.truncated_normal_initializer(stddev=0.01))
    # BN?
    concatenated = tf.concat([br0, br1, br2], 3)
    fx = tf.layers.conv2d(concatenated, pool2.get_shape()[3], [1, 1], padding='SAME',
                          activation=None,
    ...
    identity += scale * fx #scale = 1.0
    convnet = tf.nn.relu(identity)

    ################################################


    conv3 = tf.layers.conv2d(convnet, 192*2, [3, 3], padding='SAME',
